...
## OM and Director
fly -t storm set-pipeline -p deploy-om-and-director -c pipelines/om-and-director-pipeline.yml -l environments/${iaas}/${environment}/common-pipeline-params.yml -n
fly -t storm unpause-pipeline -p deploy-om-and-director
